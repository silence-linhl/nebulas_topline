...
var createItem = function(comment) {
  var item =
    '<hr/><li class="media"><div class="media-left"></div>' +
    '<div class="media-body"><h5 class="media-heading" style="font-weight:bold">' +
    comment.publisher +
    "</h5><p>" +
    comment.content +
    '</p><div style="text-align: right"><span>' +
    timestampToTime(comment.publishTime) +
    "</span>&nbsp; </div> </div></li>";
